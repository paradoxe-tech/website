...
if(!urlParams.has('embed')) {
  if(queryString.includes('home.html')) console.log('HOME WARN')
  document.querySelector('.main').style.paddingLeft = "3%"
}
...
if(isMobile()) location.href = "https://callmekitsu.kitsuforyou.repl.co/home/mobile.html"
...
function doActus(list, theme, modifier) {
  ...
  let sec_actu_cover = document.createElement('img')
    sec_actu_cover.src = actus[1].cover_path.replace('__SITE__', modifier)
  ...
  let third_actu_cover = document.createElement('img')
    third_actu_cover.src = actus[2].cover_path.replace('__SITE__', modifier)
